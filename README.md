...
deploy/
  bootstrap.sh            # ↓2つ+OAuthトークン登録+動作確認を通しで行う1コマンド構築
...
OAuthクライアントJSONを用意した状態なら、以下の1コマンドで構築〜動作確認まで完了する:
...
1. **RIZAP側への事前依頼**（[docs/iam-request.md](docs/iam-request.md) を送付）
